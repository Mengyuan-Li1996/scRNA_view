...
library(DT)
library(shinythemes)
setwd("/Users/k20028367/OneDrive - King's College London/R/Spatial_transcriptome/Rshiny_gene_expression/online_test/shiny_cell_browser")
json_file <- rjson::fromJSON(file = './data/example_config.json')
